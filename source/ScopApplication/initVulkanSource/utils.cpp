...
bool ScopApplication::isDeviceSuitable(VkPhysicalDevice device) {
...
QueueFamilyIndices ScopApplication::findQueueFamilies(VkPhysicalDevice device, VkQueueFlagBits flags) {
...
bool ScopApplication::checkPhysicalDeviceExtensionSupport(VkPhysicalDevice device) {
...
void ScopApplication::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
...
void ScopApplication::printValidationLayerSupport() {
    uint32_t layerCount;
...
void ScopApplication::printAvailableVulkanExtension() {
...
void ScopApplication::printAvailableGlfwExtension(vector<const char *> &glfwExtensions) {
...
void ScopApplication::printAvailablePhysicalDevices() {
...
void ScopApplication::printQueueFamilies(VkPhysicalDevice device) {
    uint32_t queueFamilyCount = 0;
    vkGetPhysicalDeviceQueueFamilyProperties(device, &queueFamilyCount, nullptr);
...
void ScopApplication::printQueueFamilyIndices(const QueueFamilyIndices &QFindices) {
...
void ScopApplication::printSupportedPhysicalDeviceExtensions() {
    uint32_t extensionCount = 0;
...
VkFormat ScopApplication::findSupportedFormat(
...
VkFormat ScopApplication::findDepthFormat() {
...
bool ScopApplication::hasStencilComponent(VkFormat format) {
