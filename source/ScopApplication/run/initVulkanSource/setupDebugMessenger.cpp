...
void ScopApplication::setupDebugMessenger() {
...
void ScopApplication::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT &createInfo) {
    createInfo = {};
...
/* static */ VKAPI_ATTR VkBool32 VKAPI_CALL ScopApplication::debugCallback(
...
/* static */ VkResult ScopApplication::CreateDebugUtilsMessengerEXT(
    VkInstance instance,
...
/* static */ void ScopApplication::DestroyDebugUtilsMessengerEXT(
    VkInstance instance,
